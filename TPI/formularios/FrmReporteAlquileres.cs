    ...
    public partial class FrmReporteAlquileres : Form
    {
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            DataTable dt = HelperDB.GetInstance().ConsultaSQL(
                "SELECT t_Alquileres.Numero_Alquiler, t_Alquileres.Fecha_Entrega, t_Alquileres.Fecha_Devolucion, t_Alquileres.Direccion, t_Detalles_Alquiler.Codigo_Herramienta, t_Herramientas.Marca_Herramienta, t_Herramientas.Modelo_Herramienta " +
                "FROM t_Alquileres " +
                "JOIN t_Detalles_Alquiler ON t_Alquileres.Numero_Alquiler = t_Detalles_Alquiler.Numero_Alquiler " +
                "JOIN t_Herramientas ON t_Detalles_Alquiler.Codigo_Herramienta = t_Herramientas.Cod_Herramienta " +
        ...
        private void FrmReporteAlquileres_Load(object sender, EventArgs e)
        {
